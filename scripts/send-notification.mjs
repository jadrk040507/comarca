...
const r=await fetch('https://api.onesignal.com/notifications',{method:'POST',headers:{Authorization:`Key ${apiKey}`,'Content-Type':'application/json'},body:JSON.stringify({app_id:appId,target_channel:'push',included_segments:['Subscribed Users'],headings:{en:title,es:title},contents:{en:message,es:message},url:'https://jadrk040507.github.io/comarca/agenda/',idempotency_key:key}),signal:AbortSignal.timeout(30000)});
