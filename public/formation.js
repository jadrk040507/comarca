...
function initPrayerbook(){
 ...
 let savedLanguage='es';try{savedLanguage=localStorage.getItem('comarca-prayer-language')||'es';const savedSize=localStorage.getItem('comarca-prayer-size');if(['normal','large','larger'].includes(savedSize)){size.value=savedSize;root.dataset.readingSize=savedSize;}}catch{}language(savedLanguage);
